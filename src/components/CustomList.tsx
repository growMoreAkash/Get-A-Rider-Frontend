...
const TypeBrandCategoryList: React.FC<TypeBrandCategoryListProps> = ({ columns, data, actions, onRefresh, onTrashed, onViewLog }) => {
            ...
            <div className="p-4">
                <div className="flex flex-wrap justify-between items-center gap-4 mb-4">
                    ...
                    <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
                        ...
                        {onTrashed && (
                            <button className="btn hover:bg-teal-500 hover:text-white border-teal-600 text-teal-600 shadow-none px-3" onClick={() => alert("Manage Trashed Data is comming soon")} title="Manage Trashed Data">
                                    ...
                                    {actions && (
                                        <td className="py-2 px-4 flex justify-center gap-2">
                                            {actions.map((action, actionIndex) => (
                                                <button key={actionIndex} onClick={() => action.onClick(row)} className={`text-xl ${action.className}`} title={action.title}>
